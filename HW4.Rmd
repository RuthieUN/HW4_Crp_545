...
# Incoporating GWAS using discovered QTNs as covariate to perform MAS
```{r, echo=FALSE, include=FALSE}
set.seed(99164)
...
# GWAS incoporated into GS using gBLUP kinship and QTN as Covariate 
```{r, echo=FALSE, include=FALSE}
set.seed(99164)
...
# Running the GWAS without using the training set to see the prediction accuracy and also a reduced h2 of 0.5 to compare accuracy.
```{r, echo=FALSE, include=FALSE}
